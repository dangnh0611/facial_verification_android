...
public class FaceAuthPipeline {
    ...
    // Base(standard) facial landmarks for face alignment
    ...
    // 5 facial landmarks for face alignment
    ...
    private boolean isSameReal = false;
    private final float[][] savedFaceEmbeddings;
    ...
    private final FaceAntiSpoofing faceAntiSpoofing;
    private final FaceRecognition faceRecognition;

    public FaceAuthPipeline(AssetManager assetManager, float[][] savedFaceEmbeddings) throws IOException {
