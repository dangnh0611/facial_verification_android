...
public class FaceAuthCameraActivity extends BaseCameraActivity {
    ...
    private void sendFaceAuthRequest(boolean success) {
        ...
        try {
            ...
            Intent faceLoginSucessIntent = new Intent(FaceAuthCameraActivity.this, FaceCameraStatusActivity.class);
